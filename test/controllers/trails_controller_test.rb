...
class TrailsControllerTest < ActionController::TestCase
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post :create, trail: { coordinates: @trail.coordinates, image: @trail.image, trailname: @trail.trailname }
    end
  ...
  test "should update trail" do
    patch :update, id: @trail, trail: { coordinates: @trail.coordinates, image: @trail.image, trailname: @trail.trailname }
    assert_redirected_to trail_path(assigns(:trail))
  end
